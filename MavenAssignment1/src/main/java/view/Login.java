...
public class Login extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Teacher", "Student" }));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(errorLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(layout.createSequentialGroup()
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        if (!usernameField.getText().equals("abc") || !passwordField.getText().equals("abc")){
            ...
            if(jComboBox1.getEditor().getItem().equals("Teacher"))
            {
                t = new TeacherView();
                this.dispose();
                t.setVisible(true);
            ...
            else if (jComboBox1.getEditor().getItem().equals("Student"))
            {   s = new StudentView();
                this.dispose();
                s.setVisible(true);
            }
            else{
                errorLabel.setText("Choose role!");
            }
        }
